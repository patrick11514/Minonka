...
**IMPORTANT**: Never manually edit `src/types/database.ts`. This file is autogenerated by `pnpm run genDatabaseSchema` but is committed to git. Always use migrations to change scalar types.
